  ...
  return (
    <div className="min-h-screen overflow-hidden">
      ...
      <section className="relative min-h-screen flex items-center justify-center pt-16 overflow-hidden">
        ...
        {/* Complex gradient background at bottom */}
        <div className="relative h-60 w-full z-[19] mt-8 absolute bottom-0">
          <div className="absolute bottom-0 left-1/2 z-0 h-[400px] w-[1200px] -translate-x-1/2 transform overflow-hidden" style={{maskImage: "linear-gradient(to right, transparent, black 30%, black 70%, transparent)"}}>
            ...
            <div className="absolute right-[-510px] bottom-[-759px] left-[-532px] aspect-[2.346820809248555/1] h-[956px] rounded-[100%] shadow-[inset_0_2px_20px_#fff,0_-10px_50px_1px_#ffffff7d] dark:bg-black" style={{boxShadow: "rgb(255, 255, 255) 0px 2px 29.2091px inset, rgba(255, 255, 255, 0.624) 0px -10px 59.209px 1px"}}></div>
          </div>
        </div>
